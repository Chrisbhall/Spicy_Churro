...
emails = ['@gmail.com', '@gmail.ca', '@hotmail.ca', '@hotmail.com', '@gmail.com' ]
phone = [647,416,905,289]

for (let i = 0; i < 500; i++) {
  let a = names[[Math.floor(Math.random()*names.length)]]
  let b = last_names[Math.floor(Math.random()*last_names.length)]
  console.log(`INSERT INTO users (name, email, phone, backup_phone, password) VALUES ('${a} ${b}', '${a}${b}${Math.floor(Math.random()*1000)}${emails[[Math.floor(Math.random()*emails.length)]]}', ${phone[[Math.floor(Math.random()*phone.length)]]}${Math.floor(Math.random()*9000000) + 1000000}, ${phone[[Math.floor(Math.random()*phone.length)]]}${Math.floor(Math.random()*9000000) + 1000000}, '$2a$10$FB/BOAVhpuLvpOREQVmvmezD4ED/.JBIDRh70tGevYzYzQgFId2u.');`)
}
