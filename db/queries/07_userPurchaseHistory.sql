SELECT name, COUNT(order_id) as num_or_orders,SUM(total_items_purchased) as total_items_purchased, SUM(total_cost_for_order) as total_amount_purchased_by_user
