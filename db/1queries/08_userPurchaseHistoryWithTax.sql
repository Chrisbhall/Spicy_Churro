SELECT name, COUNT(order_id) as num_of_orders,SUM(total_items_purchased) as total_items_purchased, ROUND(1.13*(SUM(total_cost_for_order))) as total_amount_purchased_by_user
